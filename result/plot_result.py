...
plt.savefig('uniform_insert.png')
plt.show()

plt.cla()
with open('result/linearHash_uniform_search_timestamp.txt') as f:
	data = [x.split(' ',1) for x in f.read().splitlines()]
	linearXasis = [float(x[0])/keySize for x in data[offset:]]
	linearYasis = [x[1] for x in data[offset:]]
with open('result/chainedHash_uniform_search_timestamp.txt') as f:
	data = [x.split(' ',1) for x in f.read().splitlines()]
	chainedXasis = [float(x[0])/keySize for x in data[offset:]]
	chainedYasis = [x[1] for x in data[offset:]]
with open('result/cuckooHash_uniform_search_timestamp.txt') as f:
	data = [x.split(' ',1) for x in f.read().splitlines()]
	cuckooXasis = [float(x[0])/keySize for x in data[offset:]]
	cuckooYasis = [x[1] for x in data[offset:]]
with open('result/doubleHash_uniform_search_timestamp.txt') as f:
	data = [x.split(' ',1) for x in f.read().splitlines()]
	doubleXasis = [float(x[0])/keySize for x in data[offset:]]
	doubleYasis = [x[1] for x in data[offset:]]
...
plt.plot(doubleXasis, doubleYasis, '-', color='#1f77b4ff')
plt.legend(['linear hashing', 'chained hashing', 'cuckoo hashing', 'double hashing'], loc='upper left')
plt.savefig('uniform_search.png')
plt.show()

plt.cla()
with open('result/linearHash_uniform_delete_timestamp.txt') as f:
	data = [x.split(' ',1) for x in f.read().splitlines()]
	linearXasis = [float(x[0])/keySize for x in data[offset:]]
	linearYasis = [x[1] for x in data[offset:]]
with open('result/chainedHash_uniform_delete_timestamp.txt') as f:
	data = [x.split(' ',1) for x in f.read().splitlines()]
	chainedXasis = [float(x[0])/keySize for x in data[offset:]]
	chainedYasis = [x[1] for x in data[offset:]]
with open('result/cuckooHash_uniform_delete_timestamp.txt') as f:
	data = [x.split(' ',1) for x in f.read().splitlines()]
	cuckooXasis = [float(x[0])/keySize for x in data[offset:]]
	cuckooYasis = [x[1] for x in data[offset:]]
with open('result/doubleHash_uniform_delete_timestamp.txt') as f:
	data = [x.split(' ',1) for x in f.read().splitlines()]
	doubleXasis = [float(x[0])/keySize for x in data[offset:]]
	doubleYasis = [x[1] for x in data[offset:]]
...
plt.plot(doubleXasis, doubleYasis, '-', color='#1f77b4ff')
plt.legend(['linear hashing', 'chained hashing', 'cuckoo hashing', 'double hashing'], loc='upper left')
plt.savefig('uniform_delete.png')
plt.show()
